...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="">
                            <label for="selectReportActivity" class="labelSelect">Pilih Buku Kas</label>
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <input type="text" name="lap_tgl" class="lap_tgl datepicker mt-4" id="lap_tgl_activity" size="15"
                            title="Klik untuk mengganti tanggal" value="{{ date('d-m-Y') }}">
                    </div>
                </div>
    ...
    <script src="{{ asset('assets/js/aktivitas.js') }}"></script>
