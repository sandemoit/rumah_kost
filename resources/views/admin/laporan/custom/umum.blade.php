                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('laporan.custom.umum') }}"
                                        class="nav-link {{ request()->segment(2) == 'custom' && !request()->segment(3) ? 'active' : (request()->segment(3) == 'umum' ? 'active' : '') }}"
                                        role="tab">Umum</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('laporan.custom.aktivitas') }}"
                                        class="nav-link {{ request()->segment(3) == 'aktivitas' ? 'active' : '' }}"
                                        role="tab">Aktivitas</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('laporan.custom.ringkasan') }}"
                                        class="nav-link {{ request()->segment(3) == 'ringkasan' ? 'active' : '' }}"
                                        role="tab">Ringkasan</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                @if (request()->segment(2) == 'custom' && !request()->segment(3) ? 'umum' : request()->segment(3) == 'umum')
                                    <x-generalCustom />
